            ...
            <div className="flex flex-col lg:flex-row lg:px-0 lg:max-w-4xl lg:mx-auto">
                ...
                <div className="bg-white w-full lg:w-[60%] flex items-center max-h-[inherit]">
                    <form action="" className="py-[60px] px-10 lg:px-[80px]">
                        <h2 className="text-3xl text-slate-600 font-semibold mb-5">Sign up to get started<span className="text-[40px] text-blue-400">.</span></h2>
                        <div className="flex flex-col gap-5 lg:gap-8 py-4">
                            ...
                            <input type="password" name="" id="" placeholder="Your Password" className="w-full border-b-2 focus:border-blue-400 outline-none py-3 px-2 "/>
